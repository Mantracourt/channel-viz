(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'WtLnFdvDZUvu1l4f1tomlsB8hcGPRIoMVOrJ8sIsY6HZV2Jt', // Unique master Xively API key to be used as a default
		defaultFeeds	= [29407], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Mantracourt RDC Data Feed', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '003366', // CSS HEX value of color to represent data (omit leading #)
